...
export const ATS_PLATFORMS: ATSPlatform[] = [
  ...
  // Mid-Market (high priority for tech)
  ...
  // SMB
  { id: 'zoho', name: 'Zoho Recruit', domain: 'zoho.com', category: 'smb', enabled: false },
  { id: 'freshteam', name: 'Freshteam', domain: 'freshworks.com', category: 'smb', enabled: false },
  
  // Technical
  { id: 'hired', name: 'Hired', domain: 'hired.com', category: 'technical', enabled: false },
  { id: 'dice', name: 'Dice', domain: 'dice.com', category: 'technical', enabled: false },
];
